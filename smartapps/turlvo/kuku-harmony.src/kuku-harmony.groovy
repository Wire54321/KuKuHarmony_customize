...
def mainChildPage() {
    ...
    return dynamicPage(name: "mainChildPage", title: "Add Device", refreshInterval: interval, uninstall: true, install: true) {    	
        ...
        if (atomicState.hub && foundDevices) {
            ...
            if (selectedDevice) {
                section("Device Type :") {
                    def deviceType = ["Default", "Aircon", "TV", "Roboking", "Fan", "AVSwitch", "Blueair", "Soundbar"]
...
def addAirconDevice() {
    ...
    section("Commands :") {            
        ...
        input name: "selectedFan", type: "enum", title: "Fan", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
    ...
    state.selectedCommands["fan"] = selectedFan
...
// Add device page for AVSwitch
def addAVSwitchDevice() {
    def labelOfCommand = getLabelsOfCommands(atomicState.deviceCommands)
    state.selectedCommands = [:]    
    ...
    section("Commands :") {            
        ...
        input name: "selectedPowerOn", type: "enum", title: "Power On", options: labelOfCommand, submitOnChange: true, multiple: false, required: true
        input name: "selectedPowerOff", type: "enum", title: "Power Off", options: labelOfCommand, submitOnChange: true, multiple: false, required: true
        input name: "selectedAudio2Ch", type: "enum", title: "Audio 2Ch", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedAudio51Ch", type: "enum", title: "Audio 5.1Ch", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedAudioAdv", type: "enum", title: "Audio Adv", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "selectedAudioArc", type: "enum", title: "Audio Arc", options: labelOfCommand, submitOnChange: true, multiple: false, required: false    
        input name: "selectedAudioSpdif", type: "enum", title: "Audio Spdif", options: labelOfCommand, submitOnChange: true, multiple: false, required: false      
        input name: "A1", type: "enum", title: "A1", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "A2", type: "enum", title: "A2", options: labelOfCommand, submitOnChange: true, multiple: false, required: false    
        input name: "A3", type: "enum", title: "A3", options: labelOfCommand, submitOnChange: true, multiple: false, required: false              
        input name: "A4", type: "enum", title: "A4", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "B1", type: "enum", title: "B1", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "B2", type: "enum", title: "B2", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "B3", type: "enum", title: "B3", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "B4", type: "enum", title: "B4", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
    }
    
    //state.selectedCommands["power"] = selectedPowerToggle
    state.selectedCommands["power-on"] = selectedPowerOn
    state.selectedCommands["power-off"] = selectedPowerOff  
	state.selectedCommands["Audio2Ch"] = selectedAudio2Ch
    state.selectedCommands["Audio51Ch"] = selectedAudio51Ch
    state.selectedCommands["AudioAdv"] = selectedAudioAdv
    state.selectedCommands["AudioArc"] = selectedAudioArc
    state.selectedCommands["AudioSpdif"] = selectedAudioSpdif
    state.selectedCommands["A1"] = A1
    state.selectedCommands["A2"] = A2
    state.selectedCommands["A3"] = A3
    state.selectedCommands["A4"] = A4
    state.selectedCommands["B1"] = B1
    state.selectedCommands["B2"] = B2
    state.selectedCommands["B3"] = B3
    state.selectedCommands["B4"] = B4
    
	powerMonitorMenu()
}


// Add device page for Blueair device
def addBlueairDevice() {
    def labelOfCommand = getLabelsOfCommands(atomicState.deviceCommands)
    state.selectedCommands = [:]  
    ...
    section("Commands :") {            
        ...
        input name: "selectedPowerOn", type: "enum", title: "Power On", options: labelOfCommand, submitOnChange: true, multiple: false, required: true
        input name: "selectedPowerOff", type: "enum", title: "Power Off", options: labelOfCommand, submitOnChange: true, multiple: false, required: true
        input name: "selectedMinus", type: "enum", title: "Minus", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedPlus", type: "enum", title: "Plus", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedTimer", type: "enum", title: "Timer", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "SelectedSpeed", type: "enum", title: "Speed", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "SelectedPreset", type: "enum", title: "Preset", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
    }
    //state.selectedCommands["power"] = selectedPower
    state.selectedCommands["power-on"] = selectedPowerOn
    state.selectedCommands["power-off"] = selectedPowerOff    
    state.selectedCommands["minus"] = selectedMinus
    state.selectedCommands["plus"] = selectedPlus
    state.selectedCommands["timer"] = selectedTimer
    state.selectedCommands["speed"] = SelectedSpeed
    state.selectedCommands["preset"] = SelectedPreset

	powerMonitorMenu()
}

// Add device page for Soundbar device
def addSoundbarDevice() {
    def labelOfCommand = getLabelsOfCommands(atomicState.deviceCommands)
    state.selectedCommands = [:]  
    ...
    section("Commands :") {            
        ...
        input name: "selectedPowerOn", type: "enum", title: "Power On", options: labelOfCommand, submitOnChange: true, multiple: false, required: true
        input name: "selectedPowerOff", type: "enum", title: "Power Off", options: labelOfCommand, submitOnChange: true, multiple: false, required: true
        input name: "selectedInputAnalog", type: "enum", title: "Input Analog", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedInputBdDvd", type: "enum", title: "Input BD'/'DVD", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedInputBluetooth", type: "enum", title: "Input Bluetooth", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedInputCoaxial", type: "enum", title: "Input Coaxial", options: labelOfCommand, submitOnChange: true, multiple: false, required: false
        input name: "selectedInputTv", type: "enum", title: "Input Tv", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "volup", type: "enum", title: "Volume Up", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "voldown", type: "enum", title: "Volume Down", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "mute", type: "enum", title: "Mute", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "subwoofup", type: "enum", title: "Sub Woof Up", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "subwoofdown", type: "enum", title: "Sub Woof Down", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "audiodelay", type: "enum", title: "Audio Delay", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "bluetoothstanby", type: "enum", title: "Bluetooth Stanby", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "chlevel", type: "enum", title: "Ch Level", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "clearvoice", type: "enum", title: "Clear Voice", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "dspgame", type: "enum", title: "Dsp Game", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "dspmovie", type: "enum", title: "Dsp Movie", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "dspmusic", type: "enum", title: "Dsp Music", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "dspsports", type: "enum", title: "Dsp Sports", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "dsptv", type: "enum", title: "Dsp Tv", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "stereo", type: "enum", title: "Stereo", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
        input name: "univolume", type: "enum", title: "Uni Volume", options: labelOfCommand, submitOnChange: true, multiple: false, required: false  
    ...
    state.selectedCommands["power-on"] = selectedPowerOn
    state.selectedCommands["power-off"] = selectedPowerOff    
    state.selectedCommands["inputanalog"] = selectedInputAnalog
    state.selectedCommands["inputbddvd"] = selectedInputBdDvd
    state.selectedCommands["inputbluetooth"] = selectedInputBluetooth
    state.selectedCommands["inputcoaxial"] = selectedInputCoaxial
    state.selectedCommands["inputtv"] = selectedInputTv
    state.selectedCommands["volup"] = volup
    state.selectedCommands["voldown"] = voldown
    state.selectedCommands["mute"] = mute
    state.selectedCommands["subwoofup"] = subwoofup    
    state.selectedCommands["subwoofdown"] = subwoofdown   
    state.selectedCommands["audiodelay"] = audiodelay   
    state.selectedCommands["bluetoothstanby"] = bluetoothstanby   
    state.selectedCommands["chlevel"] = chlevel   
    state.selectedCommands["clearvoice"] = clearvoice   
    state.selectedCommands["dspgame"] = dspgame   
    state.selectedCommands["dspmovie"] = dspmovie   
    state.selectedCommands["dspmusic"] = dspmusic   
    state.selectedCommands["dspsports"] = dspsports   
    state.selectedCommands["dsptv"] = dsptv
    state.selectedCommands["stereo"] = stereo
    state.selectedCommands["univolume"] = univolume
