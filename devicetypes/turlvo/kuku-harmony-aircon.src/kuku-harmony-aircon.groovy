...
metadata {
	...
	tiles (scale: 2){      
        ...
        valueTile("fan", "device.fan", width: 2, height: 2, decoration: "flat", canChangeIcon: false, canChangeBackground: false) {
            state "yes", label: "Fan MODE", action: "fan"
            state "no", label: "unavail", action: ""
        }
        
        valueTile("cool", "device.cool", width: 2, height: 2, decoration: "flat", canChangeIcon: false, canChangeBackground: false) {
            state "yes", label: "Cool MODE", action: "cool"
            state "no", label: "unavail", action: ""
        }
